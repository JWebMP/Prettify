        ...
        implements IPageConfigurator<PrettifyPageConfigurator>
{
    ...
    {
        return PrettifyPageConfigurator.enabled;
    }
    ...
    {
        PrettifyPageConfigurator.enabled = mustEnable;
    }

    public static SourceCodePrettifyThemes getTheme()
    {
        return PrettifyPageConfigurator.theme;
    }

    public static void setTheme(SourceCodePrettifyThemes theme)
    {
        PrettifyPageConfigurator.theme = theme;
    }
    ...
    public IPage<?> configure(IPage<?> page)
    {
        if (enabled())
        {
            ...
            page.getBody()
                ...
                .asDependencyBase()
                .getCssReferences()
                .add(PrettifyPageConfigurator.theme.getCssReference());
        }
        return page;
    }
